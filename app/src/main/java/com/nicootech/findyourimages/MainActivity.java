...
import com.nicootech.findyourimages.adapter.MyAdapter;
import com.nicootech.findyourimages.pojo.ImagePojo;
import com.nicootech.findyourimages.presenter.MainActivityPresenterImpl;
...
public class MainActivity extends BaseActivity implements MainActivityView {
    ...
    protected void initViews() {
        ...
        materialSearchView.setQueryHint(getString(R.string.what_photo));
        mProgressbar = findViewById(R.id.progressbar);
        mNoResult = findViewById(R.id.no_result);
        mToolbarTitle = findViewById(R.id.toolbar_text);
    ...
    public void setUpAdapter(){
        ...
        allMyAdapter = new MyAdapter(this,items,cache);
        mRecyclerview.setAdapter(allMyAdapter);
    ...
    public void onSearchSuccess(JsonArray jsonArray) {
        if(jsonArray.size()==0 && page==1)
            ...
            allMyAdapter.notifyDataSetChanged();
        }
    }
